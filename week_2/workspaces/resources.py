...
@resource (
    ...
    description="A resource that can get S3 client",
)
def s3_resource(context):
    """This resource defines a S3 client"""
    return S3(bucket=context.resource_config["bucket"],
...
@resource (
    ...
    description="A resource that can get Redis client",
)
@resource
def redis_resource(context):
    """This resource defines a Redis client"""
    return Redis(host=context.resource_config["host"],
